...
import { updateCommentOnBlog } from '../../Actions/CommentReplyActiion';
  ...
  const handleMsg = () => {
    ...
    const updateCommentHandler = async (e) => {
      ...
      if(!commentBody){
          ...
          await dispatch(updateCommentOnBlog(commentBody, commentImage, commentId, selectedBlog._id));
          setCommentImage('');
          onClose();
...
export default UpdateCommentBlog
