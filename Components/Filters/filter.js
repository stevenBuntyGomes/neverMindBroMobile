...
export const filterFunction = (inputText, filterType) => {
    ...
    if (filterType === 'confess_propose') {
        return filterSlang(proposeOrConfess(inputText));
    }
    if (filterType === 'tariff') {
        return filterSlang(tariff(inputText));
    }
...
const proposeOrConfess = (inputText) => {
    const proposals = [
        "'💖 Will you be mine?'",
...
const tariff = (inputText) => {
    const trumpTariffLines = [
        "'💸 Countries are calling us up, kissing my ass.'",
        "'📦 Liberation Day, folks. You’re welcome.'",
        "'🔥 People were getting yippy!'",
        "'🚀 We're putting America first — again!'",
        "'📈 Markets? They’ll boom. Trust me!'",
        "'🇨🇦 Say hi to the Governor of the Great State of Canada!'",
        "'💣 Tremendous tariffs. Just tremendous.'",
        "'📊 We’re winning the trade war so hard, it’s unfair... to the world!'",
        "'🧠 Nobody understands trade like I do. Nobody.'",
        "'🍔 You’ll pay a little more — but you’ll feel very American doing it.'",
        "'🪙 Tariffs make everything better. That's how deals work, folks.'",
        "'🇲🇽 Mexico loves the tariffs. They told me. Big fans.'",
        "'💼 It’s a beautiful thing. So beautiful, it’ll make your head spin.'",
        "'⚖️ China? Huge problem. But I fixed it. You're welcome.'",
        "'📢 The EU? A total disaster. Sad!'",
        "'📉 Fake economists say it’ll hurt us. But guess what? We’re thriving!'",
        "'🎉 It's a celebration of American greatness. Call it Liberation Day 2.0!'",
        "'🚫 No more freebies. We’re charging rent now!'",
        "'🥇 I invented the art of the tariff. It’s in my DNA.'",
        "'💰 We tax them, they cry. It's so good!'",
        "'🥊 It's not a trade war. It's a trade lesson. For the world.'",
        "'🤯 Other countries are losing their minds. That means it’s working.'",
        "'👔 I don’t need advisors. I’ve got instincts. Instincts beat PhDs!'",
        "'🧠 You want real economics? Just listen to me.'",
        "'🎯 Tariffs are like chess. And I’m the grandmaster.'"
    ];
