    ...
    return (
      ...
      const writeReplyHandler = async (e) => {
        ...
        if(!replyBody){
            ...
            await dispatch(updateReplyAnswerAction(replyBody, replyImage, reactionAnswer._id, commentId, replyId));
            setReplyImage('');
...
export default UpdateReplyAnswer