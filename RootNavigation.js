...
export default function RootNavigation () {
    ...
    const { auth } = useSelector((state) => state.user); // Get authenticated user
    ...
    }, [auth?.name, socketConnected, navigationRef.getCurrentRoute()?.name, dispatch]);
    ...
    }, [auth?.name, socketConnected, navigationRef.getCurrentRoute()?.name]);
