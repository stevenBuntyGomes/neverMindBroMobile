...
export const API = process.env.PRODUCTION ? 'https://api.nevermindbro.com/api' : "https://api.nevermindbro.com/api";
...
export const ENDPOINT = "https://api.nevermindbro.com/api";
